 ...
 * 
 * Run with: node generate-haircut-images.js [options]
 * 
 * Options:
 ...
 *   
 * Examples:
 *   node generate-haircut-images.js --male --limit=5
 *   node generate-haircut-images.js --id=3
 */
...
// Import haircut data
import('./client/src/data/haircuts.js').then(async (module) => {
  const { maleHaircuts, femaleHaircuts } = module;
  ...
  console.error('Error importing haircuts data:', error);
  process.exit(1);
});