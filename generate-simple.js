...
// Import haircut data
const maleHaircuts = require('./client/src/data/haircuts').maleHaircuts;
const femaleHaircuts = require('./client/src/data/haircuts').femaleHaircuts;
...
async function main() {
  ...
  if (args.includes('--help')) {
    console.log(`
Usage: node generate-simple.js [options]
